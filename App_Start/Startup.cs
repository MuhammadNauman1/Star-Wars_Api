...
using ReactStartApi.Config;
using ReactStartApi.Constraints;
using ReactStartApi.ExceptionHandlers;
using ReactStartApi.Filters;
using ReactStartApi.Loggers;
...
[assembly: OwinStartup(typeof(ReactStartApi.Startup))]
        ...
        private void ConfigureSwashbuckle(HttpConfiguration config)
        {
            config
                .EnableSwagger(c =>
                {
                    ...
                    var xmlDocPath = $"{AppDomain.CurrentDomain.BaseDirectory}\\bin\\ReactStartApi.xml";
